...
import com.huyen.bookeeshop.entity.InvalidatedToken;
...
import com.huyen.bookeeshop.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    private SignedJWT verifyToken(String token, boolean isRefresh) throws JOSEException, ParseException {
        ...
        var verified = signedJWT.verify(verifier); // Hàm này sẽ trả về true or false
